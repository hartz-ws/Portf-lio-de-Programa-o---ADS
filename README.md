...
# Minhas atividades de Análise de Dados, Criação de Bibliotecas, Listas, Dicionários e entre outros. 

Meu projeto executa diversas tarefas interrelacionadas, contendo exercícios de Análise de Dados utilizando Python, Importação de Bibliotecas como Pandas/NumPy, Importação sqlite3 para Banco de Dados e entre mais funções. 
